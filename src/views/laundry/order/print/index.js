		...
		<div className="invoice-print">
			<div className="row ml-1" style={{ width: '302px' }}>
				...
				<div className="d-flex justify-content-between flex-md-row flex-column pb-2">
					...
					<div className="mt-md-0 mt-2">
						...
						<div className="invoice-date-wrapper">
							...
							<span className="invoice-date">₦{selectedOrder?.amountPaid.toLocaleString()}</span>
						</div>
						<div className="invoice-date-wrapper">
							<span className="invoice-date-title">Balance:</span>
							<span className="invoice-date">₦{selectedOrder?.balance.toLocaleString()}</span>
						</div>
						<div className="invoice-date-wrapper">
							<span className="invoice-date-title">Status:</span>
							<span className="invoice-date">
								<Badge className="text-capitalize" color={statusObj[selectedOrder?.orderStatus]} pill>
				...
				<Table className="mt-2 mb-0" size="20">
					...
					<tbody>{renderTable(selectedOrder?.services)}</tbody>
				</Table>
