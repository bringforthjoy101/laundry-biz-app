...
const AnalyticsDashboard = () => {
	...
	return (
		<div id="dashboard-analytics">
			...
			<Row className="match-height">
				<Col xl="2" md="4" sm="6">
					<StatsVertical icon={<Eye size={21} />} color="primary" stats={numFormatter(dashData.totalServices)} statTitle="Services" />
				</Col>
				<Col xl="2" md="4" sm="6">
					<StatsVertical icon={<Eye size={21} />} color="warning" stats={numFormatter(dashData.totalOrders)} statTitle="Orders" />
				</Col>
				<Col xl="2" md="4" sm="6">
					<StatsVertical icon={<Eye size={21} />} color="secondary" stats={numFormatter(dashData.totalClients)} statTitle="Clients" />
				</Col>
				<Col xl="2" md="4" sm="6">
					<StatsVertical
